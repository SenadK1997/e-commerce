...
<template>
    <section class="c-section">
        <div class="c-section__heading">
            <div class="c-section-hamburger" @click="activeDrop" :class="{ 'c-section-hamburger-active' : dropDown }">
                <div></div>
                <div></div>
                <div></div>
            </div>
        ...
        <div class="c-section__container">
            <div class="c-section__container-left" :class="{ 'c-section__container-left-active' : dropDown }">
                <div>Collections</div>
                <div>Men</div>
                <div>Women</div>
                <div>About</div>
            ...
            <div class="c-section__container-right">
                <div class="c-section-parent__cart">    
                    ...
                    <div class="cart-counter" v-if="counterActive">{{articles.counter}}</div>
...
.c-section__container-left {
    display: flex;
    margin-left: 15px;
}
.c-section__container-left div {
    margin-left: 35px;
    font-size: 18px;
    font-weight: 500;
    cursor: pointer;
...
.c-section__container-left div:hover {
    border-bottom: 4px solid orange;
    color: black;
}
.c-section__container-right {
    display: flex;
    align-items: center;
}
...
.c-section__container-left-active {
    display: block;
    transition: all 1s ease-in-out;
}
.c-section__heading {
...
.c-section__container-left div:first-of-type {
    margin-top: 105px;
}
.c-section__container-left div:hover {
    border-bottom: none;
